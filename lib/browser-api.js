...
module.exports = function (browserWindow, panel, webview) {
  ...
  if (!WindowDelegateClass) {
    WindowDelegateClass = ObjCClass({
      ...
      'windowDidEnterFullScreen:': function (
        ...
        this.utils.emitEvent('enter-full-screen')
      },
      ...
      'windowDidExitFullScreen:': function (
        ...
        this.utils.emitEvent('leave-full-screen')
      },
      ...
      'windowDidMove:': function (
        ...
        this.utils.emitEvent('move')
        this.utils.emitEvent('moved')
      },
      ...
      'windowShouldClose:': function (
        ...
        this.utils.emitEvent('close') // TODO: prevent default
      },

      'windowWillClose:': function (notification) {
        this.utils.emitEvent('closed')
      },

      'windowDidBecomeKey:': function (notification) {
        this.utils.emitEvent('focus')
      },

      'windowDidResignKey:': function (notification) {
        this.utils.emitEvent('blur')
      }
    })
  }
  ...
  windowDelegate.utils = NSDictionary.dictionaryWithDictionary({
    emitEvent: browserWindow.emitEvent.bind(browserWindow)
  })
