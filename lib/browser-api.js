...
var COLOR_CLASSES = ['NSColor', 'NSDynamicSystemColor']
...
module.exports = function (browserWindow, panel, webview) {
  ...
  browserWindow.setMaximizable = function (maximizable) {
    panel.standardWindowButton(NSWindowZoomButton) && panel.standardWindowButton(NSWindowZoomButton).setEnabled(maximizable)
  }
