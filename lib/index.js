/* globals NSUUID NSThread NSMakeRect NSTexturedBackgroundWindowMask NSTitledWindowMask NSWindowTitleHidden NSClosableWindowMask NSWindowMiniaturizeButton NSWindowZoomButton NSScreen coscript NSWindowCloseButton NSFullSizeContentViewWindowMask NSWidth NSHeight NSMiniaturizableWindowMask NSBackingStoreBuffered kCGDesktopWindowLevel NSWindowCollectionBehaviorCanJoinAllSpaces NSWindowCollectionBehaviorStationary NSWindowCollectionBehaviorIgnoresCycle NSToolbar context NSResizableWindowMask NSViewWidthSizable NSViewHeightSizable NSWindowFullScreenButton NSEventTypeLeftMouseDown NSPanel WebView sketch NSColor */
...
function BrowserWindow (options) {
  ...
  browserWindow._setBackgroundColor(
    options.transparent ? NSColor.clearColor() : (options.backgroundColor || NSColor.windowBackgroundColor())
  )
