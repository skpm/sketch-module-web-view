...
module.exports = function buildAPI(browserWindow, panel, webview) {
  ...
  if (!FrameLoadDelegateClass) {
    FrameLoadDelegateClass = ObjCClass({
      ...
      // N.B. - there are intentionally no parameters - adding parameters causes some weird bug
      // which crashes Sketch non-deterministically. It must be something to do with how they
      // are marshalled from Objective C types to Javascript types - the context parameter is
      // probably the cause...
